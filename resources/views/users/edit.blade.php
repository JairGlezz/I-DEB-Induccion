        ...
        <div class="form-container">
            ...
            <form action="{{ route('users.update', $user->id) }}" method="POST">
                ...
                <div style="position: relative;">
                    <input type="password" name="password" id="password" value="{{ old('password') }}" style="padding-right: 45px;">
                ...
                <div id="tipoUsuarioGroup" class="dynamic-field">
                    ...
                    <select name="tipo_usuario" id="tipo_usuario">
                        <option value="Colaborador" {{ old('tipo_usuario', $user->tipo_usuario) === 'Colaborador' ? 'selected' : '' }}>Colaborador</option>
                        <option value="Estadía" {{ old('tipo_usuario', $user->tipo_usuario) === 'Estadía' ? 'selected' : '' }}>Estadía</option>
                    </select>
                </div>
                ...
                <div id="tipoColaboradorGroup" class="dynamic-field">
                    ...
                    <select name="area" id="area">
                        <option value="" disabled {{ old('area', $user->area) == null ? 'selected' : '' }}>-- Selecciona un perfil --</option>
                        
                        <optgroup label="Administrativos">
                            <option value="Capital Humano" {{ strtolower(trim(old('area', $user->area))) === 'capital humano' ? 'selected' : '' }}>Capital Humano</option>
                            <option value="Gestión de pedidos" {{ strtolower(trim(old('area', $user->area))) === 'gestión de pedidos' ? 'selected' : '' }}>Gestión de pedidos</option>
                            <option value="Ingeniero de recursos materiales" {{ strtolower(trim(old('area', $user->area))) === 'ingeniero de recursos materiales' ? 'selected' : '' }}>Ingeniero de recursos materiales</option>
                            <option value="Coordinadora General" {{ strtolower(trim(old('area', $user->area))) === 'coordinadora general' ? 'selected' : '' }}>Coordinadora General</option>
                            <option value="Gerente General" {{ strtolower(trim(old('area', $user->area))) === 'gerente general' ? 'selected' : '' }}>Gerente General</option>
                            <option value="Auxiliar administrativo" {{ strtolower(trim(old('area', $user->area))) === 'auxiliar administrativo' ? 'selected' : '' }}>Auxiliar administrativo (Futuro)</option>
                        </optgroup>

                        <optgroup label="Operativos">
                            <option value="Coordinador técnico" {{ strtolower(trim(old('area', $user->area))) === 'coordinador técnico' ? 'selected' : '' }}>Coordinador técnico</option>
                            <option value="Ingeniero de control y Soporte técnico" {{ strtolower(trim(old('area', $user->area))) === 'ingeniero de control y soporte técnico' ? 'selected' : '' }}>Ingeniero de control y Soporte técnico</option>
                            <option value="Ingeniería y proyectos" {{ strtolower(trim(old('area', $user->area))) === 'ingeniería y proyectos' ? 'selected' : '' }}>Ingeniería y proyectos</option>
                            <option value="Ingeniero Junior" {{ strtolower(trim(old('area', $user->area))) === 'ingeniero junior' ? 'selected' : '' }}>Ingeniero Junior</option>
                            <option value="Ingeniero en mantenimiento y recurso materiales" {{ strtolower(trim(old('area', $user->area))) === 'ingeniero en mantenimiento y recurso materiales' ? 'selected' : '' }}>Ingeniero en mantenimiento y recurso materiales</option>
                        </optgroup>
                    </select>
                </div>

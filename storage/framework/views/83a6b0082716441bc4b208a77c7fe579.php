...
<body>
        ...
        <div class="card">
                    ...
                    <table id="reportsTable">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>   
                                <?php $__currentLoopData = $user->responses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $response): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="general-row-item">
                                        ...
                                        <td>
                                            <span class="status-badge open-q" style="background-color: #f3f4f6; color: #1f2937; border: 1px solid #e5e7eb;">
                                                <?php echo e($user->tipo_usuario ?? 'N/A'); ?>

                                                <?php if($user->area): ?>
                                                    <small style="display: block; font-size: 10px; color: #6b7280;">(<?php echo e($user->area); ?>)</small>
                                                <?php endif; ?>
                                            </span>
                                        </td>
                                        <td><?php echo e($user->created_at ? $user->created_at->setTimezone('America/Mexico_City')->format('d/m/Y H:i') : 'N/A'); ?></td>
                                        <td><?php echo e($response->question->page->title ?? 'N/A'); ?></td>
                                        <td><?php echo e($response->question->question_text); ?></td>
                                        <td><?php echo e($response->answer); ?></td>
                                        <td>
                                            <?php if($response->is_correct === null): ?>
                                                <span class="status-badge open-q">Abierta</span>
                                            <?php elseif($response->is_correct): ?>
            ...
            <div id="users-tab" class="tab-content">
                <div id="usersAccordionContainer">
                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="user-report-card" data-username="<?php echo e(strtolower($user->name)); ?>" data-useremail="<?php echo e(strtolower($user->email)); ?>">
                            <div class="user-report-header" onclick="toggleAccordion(this)">
                                <div class="user-info-meta">
                                    ...
                                    <div class="user-info-text">
                                        <h3 class="user-name-title"><?php echo e($user->name); ?></h3>
                                        <span class="user-email-subtitle"><?php echo e($user->email); ?></span>
                                        <div style="margin-top: 4px;">
                                            <span style="background: #e1e7ff; color: #404eed; padding: 2px 8px; font-size: 11px; font-weight: bold; border-radius: 4px;">
                                                <?php echo e($user->tipo_usuario); ?> <?php if($user->area): ?> | <?php echo e($user->area); ?> <?php endif; ?>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                <div class="user-header-right" onclick="event.stopPropagation();">
                                    <form method="POST" action="<?php echo e(route('admin.sendReminder', $user->id)); ?>" style="margin: 0;">
                                        <?php echo csrf_field(); ?>
                                    ...
                                    <span class="user-badge-count"><?php echo e($user->responses->count()); ?> Respuestas</span>
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $user->responses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $response): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr class="user-row-item">
                                                        <td><strong><?php echo e($response->question->page->title ?? 'N/A'); ?></strong></td>
                                                        <td><?php echo e($response->question->question_text); ?></td>
                                                        <td><?php echo e($response->answer); ?></td>
                                                        <td>
                                                            <?php if($response->is_correct === null): ?>
    ...
    <script>
        ...
        const COMPANY_LOGO_BASE64 = "data:image/jpeg;base64,<?php echo e(base64_encode(file_get_contents(public_path('images/I-DEBLogo.jpg')))); ?>";
...
</html><?php /**PATH C:\Users\jairg\OneDrive\Escritorio\I-DEB proyecto estadia\Programa induccion\Proyecto-CursoInduc\resources\views/users/reports.blade.php ENDPATH**/ ?>
...
<body>
        ...
        <div class="sidebar-footer">
            ...
            <div class="sidebar-user" onclick="toggleGearMenu(event)">
                ...
                <div class="gear-dropdown" id="gearDropdown">
                    <form method="POST" action="<?php echo e(route('logout')); ?>" onclick="event.stopPropagation();">
                        <?php echo csrf_field(); ?>
    ...
    <div class="main-content">
        ...
        <div class="print-header">
            ...
            <div class="report-title">
                ...
                <span>Fecha de Emisión: <?php echo e(date('d/m/Y H:i')); ?></span>
            </div>
        </div>
            ...
            <table id="usersTable">
                ...
                <tbody>
                    <?php $__currentLoopData = $allUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ?>
                    <tr class="<?php echo e($user->trashed() ? 'trashed-row' : ''); ?> <?php echo e(!$isInCurrentPage ? 'pdf-only-row' : ''); ?>">
                        <td data-label="ID" style="font-weight: bold;"><?php echo e($user->id); ?></td>
                        <td data-label="Nombre" style="font-weight: 600;"><?php echo e($user->name); ?></td>
                        <td data-label="Email"><?php echo e($user->email); ?></td>
                        <td data-label="Rol">
                            <span class="badge <?php echo e($user->role === 'admin' ? 'badge-admin' : 'badge-user'); ?>">
                            ...
                            <?php if($user->role === 'user'): ?>
                                <div class="progress-container">
                                    <div class="progress-track">
                                        <div class="progress-bar" style="width: <?php echo e($user->inductionViewedPercentage); ?>%;"></div>
                                    </div>
                                    <span class="progress-text"><?php echo e($user->inductionViewedPercentage); ?>%</span>
                                </div>
                            <?php else: ?>
                                <span style="color: #bbb;">---</span>
                            <?php endif; ?>
                        </td>
                        <td data-label="F. Registro" style="white-space: nowrap; font-size: 13px;"><?php echo e($user->fecha_registro); ?></td>
                        <td data-label="Acciones">
                            <div class="actions-container">
                                ...
                                <?php else: ?>
                                    <a href="<?php echo e(route('users.edit', $user->id)); ?>" class="btn-editar">Editar</a>
                                    
                                    <form action="<?php echo e(route('users.destroy', $user->id)); ?>" method="POST" onsubmit="return confirm('¿Estás seguro de que deseas dar de BAJA a este usuario?');">
                                        <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
                                        <button type="submit" class="btn-baja">Baja</button>
                                    </form>
                                <?php endif; ?>

                                <form action="<?php echo e(route('users.forceDestroy', $user->id)); ?>" method="POST" onsubmit="return confirm('⚠️ ¡ATENCIÓN! ¿Estás seguro de que deseas ELIMINAR permanentemente este registro?');">
                                    <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
    ...
    <script>
        ...
        const currentPage = <?php echo e($users->currentPage()); ?>;
...
</html><?php /**PATH C:\Users\jairg\OneDrive\Escritorio\I-DEB proyecto estadia\Programa induccion\Proyecto-CursoInduc\resources\views/users/index.blade.php ENDPATH**/ ?>